    ...
    <div className="space-y-16 px-45 py-25 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto space-y-8 text-center">
        ...
        <div className="mx-auto max-w-3xl space-y-6">
          <p className="text-lg leading-relaxed text-muted-foreground" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 300 }}>
            Experience efficient text compression using arithmetic coding powered by language models. Compress and
            decompress text with advanced algorithms that understand linguistic patterns.
          </p>
      ...
      <div className="mx-auto max-w-3xl space-y-4 border-t border-border pt-12 text-center">
        ...
        <p className="leading-relaxed text-muted-foreground" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 300 }}>
          Arithmetic coding is a form of entropy encoding that represents data as a single number in a range. By
          leveraging language model predictions, this implementation achieves superior compression ratios for natural
          language text compared to traditional methods.
        </p>
        <p className="leading-relaxed text-muted-foreground" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 300 }}>
          The algorithm analyzes the statistical properties of your text and encodes it into a more compact
          representation, which can then be perfectly reconstructed during decompression.
        </p>
      </div>
    </div>
  )
